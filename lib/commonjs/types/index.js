...
var _TabViewCarousel = require("./TabViewCarousel");
Object.keys(_TabViewCarousel).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _TabViewCarousel[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _TabViewCarousel[key];
    }
  });
});
