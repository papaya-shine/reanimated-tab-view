...
const CollapsibleScrollContainer = /*#__PURE__*/_react.default.memo(({
  ...
  const [delayedTintColor, setDelayedTintColor] = (0, _react.useState)(undefined);
  (0, _react.useEffect)(() => {
    if (refreshControlColor) {
      ...
      const interactionPromise = _reactNative.InteractionManager.runAfterInteractions(() => {
        setTimeout(() => {
          setDelayedTintColor(refreshControlColor);
        }, _refresh.IOS_REFRESH_TINT_COLOR_DELAY);
      });
