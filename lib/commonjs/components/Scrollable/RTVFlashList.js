...
function RTVFlashListInner(props, ref) {
  ...
  const flashListAnimatedRef = (0, _reactNativeReanimated.useAnimatedRef)();

  // Regular ref for JS thread operations
  const flashListRef = (0, _react.useRef)(null);
  ...
  const contentHeightSV = (0, _reactNativeReanimated.useSharedValue)(0);

  // Track viewport height as shared value too
  const viewportHeightSV = (0, _reactNativeReanimated.useSharedValue)(0);

  // Debounce onEndReached to prevent multiple rapid calls
  const lastEndReachedTimeRef = (0, _react.useRef)(0);
  ...
  (0, _react.useImperativeHandle)(ref, () => flashListRef.current);
  ...
  const triggerEndReached = (0, _react.useCallback)(() => {
    ...
    onEndReached === null || onEndReached === void 0 || onEndReached();
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => ({
    ...
    if (distanceFromEnd <= threshold) {
      (0, _reactNativeReanimated.runOnJS)(triggerEndReached)();
    }
...
const RTVFlashList = exports.RTVFlashList = /*#__PURE__*/_react.default.memo( /*#__PURE__*/(0, _react.forwardRef)(RTVFlashListInner));
